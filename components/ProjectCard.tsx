...
const ProjectCard: FunctionComponent<{ project: IProject; showDetail: null | number; setShowDetail: (id: number | null) => void;}> = ({
  project: {
    id,
    name,
    image_path,
  ...
  return (
    <>
      ...
      {showDetail ===id && (
        <div className="absolute top-0 left-0 z-10 grid w-full p-2 rounded-lg bg-p-10 gray-100 md:text-black md:ph-auto md: md:p-10 dark:bg-black-100 dark:text-gray-100 md:grid-cols-2 gap-x-12 ">
          <div>
